...
class DummyModelConfig:
    ...
    def __post_init__(self) -> None:
        ...
        # <---Commented out to prevent hugging face checking--->
        ...
        # <---architectures is dependent on the huggingface-->
...
class ParallelConfig:
    ...
    def __post_init__(self) -> None:
        # We determine world_size based on number of GPUs, and will assign the tensor and pipeline size later
...
class SpeculativeConfig:
    ...
    # type: ignore
    target_model_config: SkipValidation[DummyModelConfig] = None
    ...
    draft_model_config: SkipValidation[DummyModelConfig] = None  # type: ignore
...
class LoRAConfig:
    ...
    def verify_with_model_config(self, model_config: DummyModelConfig):
...
class MultiModalConfig:
    ...
    limit_per_prompt: dict[str, int] = \
        cast(dict[str, int], get_field(
            DummyModelConfig, "limit_mm_per_prompt"))
    """
...
class DummyVllmConfig:
    ...
    model_config: DummyModelConfig = None  # type: ignore
    """Model configuration."""
    ...
    def get_quantization_config(
        ...
        return DummyVllmConfig._get_quantization_config(copy.deepcopy(model_config),
                                                        load_config)
    ...
    def __post_init__(self):
        ...
        if self.quant_config is None and self.model_config is not None:
            self.quant_config = DummyVllmConfig._get_quantization_config(
...
_current_vllm_config: Optional[DummyVllmConfig] = None
_current_prefix: Optional[str] = None


@contextmanager
def set_current_vllm_config(vllm_config: DummyVllmConfig,
                            check_compile=False,
...
def get_current_vllm_config() -> DummyVllmConfig:
